...
function showNumberWithAnimation(i, j, randNumber)
{
    ...
    numberCell.css('top',getPosition(i));
    numberCell.css('left',getPosition(j));
    numberCell.css('diaplay','none');
    numberCell.hide();
    numberCell.fadeIn(500);
    numberCell.animate({fontSize:110},200);
    numberCell.animate({fontSize:'4em'},"fast");
}
